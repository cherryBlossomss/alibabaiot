...
public class SimpleClient4IOT {
    ...
    public static Map<String, Object> send(String mess) {
		...
		try {
			...
			try {
				map = connectMqtt(mess,targetServer, mqttclientId, mqttUsername, mqttPassword, deviceName);
			} catch (Exception message) {
				// TODO Auto-generated catch block
				message.printStackTrace();
				Map<String,Object> maps = new HashMap<>();
				System.out.println("message="+message.getMessage());
                maps.put("message",message.getMessage());
              	return maps;
			}
    ...
    public static Map<String, Object> connectMqtt(String mess ,String url, String clientId, String mqttUsername,
...
//            
        ...
        LogUtil.print("连接成功:---");
        //这里测试发送一条消息
        String content = "{'content':'msg from :" + clientId + "," + System.currentTimeMillis() + ",'message':" + mess + "'}";

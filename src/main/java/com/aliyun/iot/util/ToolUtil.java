...
//	}
    ...
    public static String StringBuilder(List l) {
    	String ret = "";
    	for(Object n : l)
    		ret += "," + n;
    ...
    /**
     * 将 a,b,c字符串 转换成 [a,b,c]列表
     * @param strs 
     * @param spliter 例如 ,
     * @return
     */
    public static List<String> ListBuilder(String strs,String spliter){
    	List<String> l = new ArrayList<String>();
    	String s = isNotEmpty(spliter)?spliter:",";
    	if (isNotEmpty(strs)) {
